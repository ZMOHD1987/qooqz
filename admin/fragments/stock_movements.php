...
?>
<link rel="stylesheet" href="/admin/assets/css/pages/stock_movements.css?v=<?= assetVer() ?>">
  ...
  <div class="product-lookup-section">
    ...
    <div class="lookup-methods">
      ...
      <div class="lookup-method">
        ...
        <button type="button" class="btn btn-primary" id="btnCameraScanner">📷 <?= _smt('lookup.open_camera', 'Open Camera') ?></button>
      </div>
    </div>
...
<script src="/admin/assets/js/pages/stock_movements.js?v=<?= assetVer() ?>"></script>
