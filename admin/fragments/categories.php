 ...
 *
 * Changes made:
 * - Added tenant management with verification via /api/tenants.
 * - Added languages management via /api/languages for translations.
 * - Translations are editable on edit, with language selection.
...
$canCreate = $isSuperAdmin || in_array('manage_categories', $permissions, true);
$canEdit = $canCreate;
$canDelete = $canCreate;
$canDuplicate = $canCreate;

// Tenant ID (respect database tables)
            ...
            <form id="categoryForm" novalidate>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="catTenantId" name="tenant_id" class="form-control" value="<?= $tenantId ?>" required>
                    ...
                    <div class="image-upload-section">
                        <div style="display:flex; align-items:center; gap:10px; margin-bottom:10px;">
                            ...
                            <div style="flex:1;">
                                ...
                                <select id="catImageType" class="form-control" style="font-size:0.85rem; display:none;"> <!-- Hidden as we force category type -->
...
window.PAGE_PERMISSIONS = <?= json_encode(['canCreate' => $canCreate, 'canEdit' => $canEdit, 'canDelete' => $canDelete, 'canDuplicate' => $canDuplicate], JSON_UNESCAPED_UNICODE) ?>;
</script>
...
<?= json_encode(['canCreate' => $canCreate, 'canEdit' => $canEdit, 'canDelete' => $canDelete, 'canDuplicate' => $canDuplicate], JSON_UNESCAPED_UNICODE) ?>
</script>
