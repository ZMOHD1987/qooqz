 ...
 * - Exposes window.API_ROLE_PERMISSIONS pointing to /api/routes/Role_permissions.php by default
 */
...
// API path (default to routes file)
$apiPath = $ADMIN_UI_PAYLOAD['api']['role_permissions'] ?? '/api/routes/Role_permissions.php';
?>
<!doctype html>
