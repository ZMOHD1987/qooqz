 ...
 * Updated to expose API path to /api/routes/permissions.php by default (or use ADMIN_UI payload)
 */
...
// Default to routes path as requested
$apiPath = $ADMIN_UI_PAYLOAD['api']['permissions'] ?? '/api/routes/permissions.php';
...
<body>
  <div id="adminPermissions" style="max-width:1200px;margin:16px auto;padding:12px;">
    ...
    <div class="table-wrap" style="border-radius:8px;">
      <table id="permTable" style="width:100%;border-collapse:collapse;">
        ...
        <tbody id="permTbody">
          <tr><td colspan="5" style="padding:12px;text-align:center;color:#666;"><?php echo htmlspecialchars(gs('permissions.loading',$flat,'Loading permissions...'), ENT_QUOTES); ?></td></tr>
        </tbody>
      </table>
    </div>
      ...
      <form id="permForm" autocomplete="off">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;">
          ...
          <div>
            ...
            <input id="permDesc" name="description" style="width:100%;padding:8px;border:1px solid var(--theme-border,#e5e7eb);border-radius:6px;">
          </div>
  ...
  <script>
    ...
    // expose path to routes entrypoint (updated)
