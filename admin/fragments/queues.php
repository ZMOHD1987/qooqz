...
<link rel="stylesheet" href="/admin/assets/css/pages/queues.css?v=<?= assetVer() ?>">
...
<div class="page-container" id="queuesPageContainer" dir="<?= htmlspecialchars($dir) ?>">
    ...
    <div class="page-header">
        ...
        <div class="page-header-actions">
            ...
            <button id="btnArchiveDone" class="btn btn-primary"><?= htmlspecialchars(_qt('actions.archive', 'Archive Done'), ENT_QUOTES, 'UTF-8') ?></button>
...
<script src="/admin/assets/js/pages/queues.js?v=<?= assetVer() ?>"></script>
