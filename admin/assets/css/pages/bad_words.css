 ...
 * Bad Words Management – Fully dynamic, no hardcoded styles.
 */
...
// ── Translation helpers for page strings ────────────────────
$_bwStrings = [];
...
<meta data-page="bad_words" data-i18n-files="/languages/BadWords/<?= rawurlencode($lang) ?>.json">
...
<div class="page-container" id="badWordsPageContainer" dir="<?= htmlspecialchars($dir) ?>">
    ...
    <div class="page-header">
        <div class="page-header-content">
            <h1 class="page-title" data-i18n="title"><?= htmlspecialchars(_bwt('title', 'Bad Words Management'), ENT_QUOTES, 'UTF-8') ?></h1>
            <p class="page-subtitle" data-i18n="subtitle"><?= htmlspecialchars(_bwt('subtitle', 'Manage blocked words and phrases'), ENT_QUOTES, 'UTF-8') ?></p>
        </div>
    ...
    <div class="card">
        <div class="card-body filter-bar">
            ...
            <button id="btnFilter" class="btn btn-primary"><?= htmlspecialchars(_bwt('filter.apply', 'Filter'), ENT_QUOTES, 'UTF-8') ?></button>
            <button id="btnClearFilters" class="btn btn-secondary"><?= htmlspecialchars(_bwt('filter.clear', 'Clear Filters'), ENT_QUOTES, 'UTF-8') ?></button>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="bad-words-table-wrapper">
    ...
    <div id="badWordModal" class="modal" style="display:none;">
        <div class="modal-content">
            <h3 id="badWordModalTitle"><?= htmlspecialchars(_bwt('modal.add_title', 'Add Bad Word'), ENT_QUOTES, 'UTF-8') ?></h3>
                ...
                <form id="badWordForm">
                    ...
                    <div class="form-group">
                        ...
                        <select name="severity" id="bwSeverity" class="form-control">
                            <option value="low"><?= htmlspecialchars(_bwt('severity.low', 'Low'), ENT_QUOTES, 'UTF-8') ?></option>
                            <option value="medium"><?= htmlspecialchars(_bwt('severity.medium', 'Medium'), ENT_QUOTES, 'UTF-8') ?></option>
                            <option value="high"><?= htmlspecialchars(_bwt('severity.high', 'High'), ENT_QUOTES, 'UTF-8') ?></option>
                        </select>
                    </div>
                    <div class="form-group form-check">
                        <input type="checkbox" name="is_regex" id="bwIsRegex" value="1">
                        <label for="bwIsRegex"><?= htmlspecialchars(_bwt('form.is_regex', 'Is Regex'), ENT_QUOTES, 'UTF-8') ?></label>
                    </div>
                    <div class="form-group form-check">
                        <input type="checkbox" name="is_active" id="bwIsActive" value="1" checked>
                        <label for="bwIsActive"><?= htmlspecialchars(_bwt('form.is_active', 'Is Active'), ENT_QUOTES, 'UTF-8') ?></label>
                    </div>
                    <div class="form-actions">
                        ...
                        <button type="button" class="btn btn-secondary btn-close-modal" data-modal="badWordModal"><?= htmlspecialchars(_bwt('form.cancel', 'Cancel'), ENT_QUOTES, 'UTF-8') ?></button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <div id="translationsModal" class="modal" style="display:none;">
        <div class="modal-content">
            <h3 id="translationsModalTitle"><?= htmlspecialchars(_bwt('translations.title', 'Word Translations'), ENT_QUOTES, 'UTF-8') ?></h3>
            <div class="modal-body">
                ...
                <div class="form-actions">
                    <button id="btnAddTranslation" class="btn btn-primary"><?= htmlspecialchars(_bwt('translations.add', 'Add Translation'), ENT_QUOTES, 'UTF-8') ?></button>
                    <button id="btnUpdateTranslation" class="btn btn-info" style="display:none;"><?= htmlspecialchars(_bwt('translations.update', 'Update'), ENT_QUOTES, 'UTF-8') ?></button>
                    <button type="button" class="btn btn-secondary btn-close-modal" data-modal="translationsModal"><?= htmlspecialchars(_bwt('form.cancel', 'Cancel'), ENT_QUOTES, 'UTF-8') ?></button>
                </div>
                <div class="bad-words-table-wrapper" style="margin-top:16px;">
    ...
    <div id="textCheckModal" class="modal" style="display:none;">
        <div class="modal-content">
            <h3><?= htmlspecialchars(_bwt('text_check.title', 'Check Text'), ENT_QUOTES, 'UTF-8') ?></h3>
            <div class="modal-body">
                <div class="form-group">
                ...
                <div class="form-actions">
                    <button id="btnCheckText" class="btn btn-primary"><?= htmlspecialchars(_bwt('text_check.check', 'Check'), ENT_QUOTES, 'UTF-8') ?></button>
                    <button type="button" class="btn btn-secondary btn-close-modal" data-modal="textCheckModal"><?= htmlspecialchars(_bwt('form.cancel', 'Cancel'), ENT_QUOTES, 'UTF-8') ?></button>
                </div>
                <div id="textCheckResults" class="check-results"></div>
            </div>
        </div>
    </div>
</div>
