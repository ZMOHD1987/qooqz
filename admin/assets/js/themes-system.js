(function() {
    ...
    async function loadThemes() {
        ...
        try {
            const data = await apiCall(`/themes/themes.php?tenant_id=${APP_CONFIG.TENANT_ID}`);
    ...
    async function saveTheme() {
        ...
        try {
            ...
            if (themeId) {
                ...
                await apiCall('/themes/themes.php', { method: 'PUT', body: payload });
            } else {
                await apiCall('/themes/themes.php', { method: 'POST', body: payload });
            }
    ...
    async function deleteTheme(themeId, themeName) {
        ...
        try {
            await apiCall('/themes/themes.php', {
                method: 'DELETE',
                body: { id: themeId, tenant_id: APP_CONFIG.TENANT_ID }
            });
    ...
    async function selectDesignTheme(themeId, themeName) {
        ...
        try {
            const data = await apiCall(`/design_settings/design_settings.php?theme_id=${themeId}`);
    ...
    async function saveDesignSettings() {
        ...
        try {
            ...
            await apiCall('/design_settings/design_settings.php', {
                method: 'POST',
                body: { updates }
            });
    ...
    async function selectColorsTheme(themeId, themeName) {
        ...
        try {
            const data = await apiCall(`/color_settings/color_settings.php?theme_id=${themeId}`);
            const settings = data.data || [];
    ...
    async function saveColorSettings() {
        ...
        try {
            ...
            await apiCall('/color_settings/color_settings.php', {
                method: 'POST',
                body: { updates }
            });
    ...
    async function selectFontsTheme(themeId, themeName) {
        ...
        try {
            const data = await apiCall(`/font_settings/font_settings.php?theme_id=${themeId}`);
            const settings = data.data || [];
    ...
    async function saveFontSettings() {
        ...
        try {
            ...
            await apiCall('/font_settings/font_settings.php', {
                method: 'POST',
                body: { updates }
            });
    ...
    async function loadButtons() {
        ...
        try {
            const data = await apiCall(`/button_styles/button_styles.php?tenant_id=${APP_CONFIG.TENANT_ID}`);
    ...
    function openButtonModal(buttonId = null) {
        ...
        if (buttonId) {
            // Load button data and populate form
    ...
    async function saveButton() {
        ...
        try {
            ...
            if (buttonId) {
                ...
                await apiCall('/button_styles/button_styles.php', { method: 'PUT', body: payload });
            } else {
                await apiCall('/button_styles/button_styles.php', { method: 'POST', body: payload });
            }
    ...
    async function deleteButton(buttonId, buttonName) {
        ...
        try {
            await apiCall('/button_styles/button_styles.php', {
                method: 'DELETE',
                body: { id: buttonId, tenant_id: APP_CONFIG.TENANT_ID }
            });
    ...
    async function loadCards() {
        ...
        try {
            const data = await apiCall(`/card_styles/card_styles.php?tenant_id=${APP_CONFIG.TENANT_ID}`);
    ...
    async function saveCard() {
        ...
        try {
            ...
            if (cardId) {
                ...
                await apiCall('/card_styles/card_styles.php', { method: 'PUT', body: payload });
            } else {
                await apiCall('/card_styles/card_styles.php', { method: 'POST', body: payload });
            }
    ...
    async function deleteCard(cardId, cardName) {
        ...
        try {
            await apiCall('/card_styles/card_styles.php', {
                method: 'DELETE',
                body: { id: cardId, tenant_id: APP_CONFIG.TENANT_ID }
            });
    ...
    async function loadHomepageSections() {
        ...
        try {
            const data = await apiCall(`/homepage_sections/homepage_sections.php?tenant_id=${APP_CONFIG.TENANT_ID}`);
    ...
    async function saveSection() {
        ...
        try {
            ...
            if (sectionId) {
                ...
                await apiCall('/homepage_sections/homepage_sections.php', { method: 'PUT', body: payload });
            } else {
                await apiCall('/homepage_sections/homepage_sections.php', { method: 'POST', body: payload });
            }
    ...
    async function deleteSection(sectionId, sectionName) {
        ...
        try {
            await apiCall('/homepage_sections/homepage_sections.php', {
                method: 'DELETE',
                body: { id: sectionId, tenant_id: APP_CONFIG.TENANT_ID }
            });
