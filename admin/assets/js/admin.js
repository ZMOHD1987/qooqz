...
(function () {
  ...
  function ensureThemeStyleContainer() {
    ...
    if (!style) {
      ...
      // place near end of head so it overrides earlier CSS
  ...
  function syncThemeVarsFromAdminUI() {
    try {
      ...
      // Prefer colors_map (server-side prepared)
      ...
      // Provide a few canonical fallbacks used by templates
      try {
  ...
  Admin.openModal = Admin.openModal;
