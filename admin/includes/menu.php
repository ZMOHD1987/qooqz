...
function render_menu_items($items, $level = 0) {
    ...
    foreach ($items as $item) {
        ...
        // i18n key priority: explicit i18n → nav.id → menu.id → fallback title
...
$ADMIN_MENU = [
    ...
    ['id'=>'platform','i18n'=>'menu.platform','icon'=>'📁','children'=>[
        ['id'=>'pages','i18n'=>'menu.pages','icon'=>'📄','url'=>'/admin/pages.php','load'=>'/admin/pages.php'],
        ['id'=>'media','i18n'=>'menu.media','icon'=>'🖼️','url'=>'/admin/media.php','load'=>'/admin/media.php'],
        ['id'=>'banners','i18n'=>'menu.banners','icon'=>'🖼️','url'=>'/admin/fragments/banners.php','load'=>'/admin/fragments/banners.php'],
    ]],
    ['id'=>'menus','i18n'=>'nav.menus','icon'=>'📋','url'=>'/admin/fragments/menus_list.php','load'=>'/admin/fragments/menus_list.php'],
    ['id'=>'roles','i18n'=>'nav.roles','icon'=>'🛡️','url'=>'/admin/roles.php','load'=>'/admin/roles.php'],
    ['id'=>'permissions','i18n'=>'nav.permissions','icon'=>'🔐','url'=>'/admin/permissions.php','load'=>'/admin/permissions.php'],
    ...
    ['id'=>'vendors','i18n'=>'menu.vendors','icon'=>'🏪','url'=>'/admin/fragments/vendors.php','load'=>'/admin/fragments/vendors.php'],
    ...
    ['id'=>'settings','i18n'=>'nav.settings','icon'=>'⚙️','url'=>'/admin/settings.php','load'=>'/admin/settings.php'],
];
