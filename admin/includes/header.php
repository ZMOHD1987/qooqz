...
.admin-sidebar {
    ...
    <?php
    // ════════════════════════════════════════════════════════════
    // NOTE: Button styles (.btn-primary, .btn-danger, etc.) are
    // generated by AdminUiThemeLoader::generateCss() using the
    // actual background_color, text_color, border_color, and
    // hover_* columns from the button_styles table.
    // That CSS is already injected above via <style id="dynamic-theme-db">.
    // No separate button CSS generation needed here.
    // ════════════════════════════════════════════════════════════
    ?>
