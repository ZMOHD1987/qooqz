...
<div class="dashboard-wrapper">
    ...
    <div class="dash-card">
        ...
        <div class="quick-actions-grid">
            <a href="/admin/fragments/products.php" data-load-url="/admin/fragments/products.php" class="action-card">
            ...
            <a href="/admin/fragments/categories.php" data-load-url="/admin/fragments/categories.php" class="action-card">
            ...
            <?php if ($canViewUsers): ?>
            <a href="/admin/fragments/users.php" data-load-url="/admin/fragments/users.php" class="action-card">
                <div class="action-icon"><i class="fas fa-users"></i></div>
                <div class="action-content"><h3 data-i18n="nav.users">Users</h3><p data-i18n="manage_users">Manage user accounts</p></div>
            </a>
            <?php endif; ?>
            <a href="/admin/fragments/tenant_users.php" data-load-url="/admin/fragments/tenant_users.php" class="action-card">
            ...
            <a href="/admin/fragments/vendors.php" data-load-url="/admin/fragments/vendors.php" class="action-card">
            ...
            <a href="/admin/fragments/IndependentDriver.php" data-load-url="/admin/fragments/IndependentDriver.php" class="action-card">
            ...
            <?php endif; ?>
            <a href="/admin/fragments/entities.php" data-load-url="/admin/fragments/entities.php" class="action-card">
            ...
            <a href="/admin/fragments/pos.php" data-load-url="/admin/fragments/pos.php" class="action-card">
            ...
            <a href="/admin/fragments/discounts.php" data-load-url="/admin/fragments/discounts.php" class="action-card">
            ...
            <a href="/admin/fragments/flash_sales.php" data-load-url="/admin/fragments/flash_sales.php" class="action-card">
            ...
            <a href="/admin/fragments/banners.php" data-load-url="/admin/fragments/banners.php" class="action-card">
            ...
            <a href="/admin/fragments/themes.php" data-load-url="/admin/fragments/themes.php" class="action-card">
