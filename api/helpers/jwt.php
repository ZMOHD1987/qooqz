...
class JWT {
     ...
     * @return array|false
     */
    public static function refreshAccessToken($refreshToken, $mysqli) {
        ...
        $stmt = $mysqli->prepare("SELECT id, email, username, user_type, status FROM users WHERE id = ?  AND status = 'active'");
