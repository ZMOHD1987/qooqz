...
class SMS {
    ...
    public static function send($phone, $message) {
        ...
        try {
            ...
            switch (SMS_PROVIDER) {
                case 'unifonic':
                    return self::sendWithUnifonicCURL($phone, $message);
                    
                case 'twilio':
                    return self::sendWithTwilio($phone, $message);
                    
                case 'nexmo':
                    return self::sendWithNexmo($phone, $message);
